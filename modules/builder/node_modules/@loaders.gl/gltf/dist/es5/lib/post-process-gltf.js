...
var GLTFPostProcessor = function () {
  ...
  (0, _createClass2["default"])(GLTFPostProcessor, [{
    ...
    value: function _resolveScene(scene, index) {
      ...
      scene = (0, _objectSpread2["default"])({}, scene);
    ...
    value: function _resolveNode(node, index) {
      ...
      node = (0, _objectSpread2["default"])({}, node);
    ...
    value: function _resolveSkin(skin, index) {
      skin = (0, _objectSpread2["default"])({}, skin);
    ...
    value: function _resolveMesh(mesh, index) {
      ...
      mesh = (0, _objectSpread2["default"])({}, mesh);
      mesh.id = mesh.id || "mesh-".concat(index);

      if (mesh.primitives) {
        mesh.primitives = mesh.primitives.map(function (primitive) {
          primitive = (0, _objectSpread2["default"])({}, primitive);
    ...
    value: function _resolveMaterial(material, index) {
      ...
      if (material.normalTexture) {
        material.normalTexture = (0, _objectSpread2["default"])({}, material.normalTexture);
        material.normalTexture.texture = this.getTexture(material.normalTexture.index);
      }

      if (material.occlusionTexture) {
        material.occlustionTexture = (0, _objectSpread2["default"])({}, material.occlustionTexture);
        material.occlusionTexture.texture = this.getTexture(material.occlusionTexture.index);
      }

      if (material.emissiveTexture) {
        material.emmisiveTexture = (0, _objectSpread2["default"])({}, material.emmisiveTexture);
        material.emissiveTexture.texture = this.getTexture(material.emissiveTexture.index);
      }

      if (material.pbrMetallicRoughness) {
        material.pbrMetallicRoughness = (0, _objectSpread2["default"])({}, material.pbrMetallicRoughness);
        var mr = material.pbrMetallicRoughness;

        if (mr.baseColorTexture) {
          mr.baseColorTexture = (0, _objectSpread2["default"])({}, mr.baseColorTexture);
          mr.baseColorTexture.texture = this.getTexture(mr.baseColorTexture.index);
        }

        if (mr.metallicRoughnessTexture) {
          mr.metallicRoughnessTexture = (0, _objectSpread2["default"])({}, mr.metallicRoughnessTexture);
    ...
    value: function _resolveAccessor(accessor, index) {
      accessor = (0, _objectSpread2["default"])({}, accessor);
    ...
    value: function _resolveTexture(texture, index) {
      texture = (0, _objectSpread2["default"])({}, texture);
    ...
    value: function _resolveSampler(sampler, index) {
      sampler = (0, _objectSpread2["default"])({}, sampler);
    ...
    value: function _resolveBufferView(bufferView, index) {
      bufferView = (0, _objectSpread2["default"])({}, bufferView);
