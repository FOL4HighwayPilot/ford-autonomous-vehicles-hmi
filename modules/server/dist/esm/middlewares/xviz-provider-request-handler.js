...
export var XVIZProviderRequestHandler = function () {
  function XVIZProviderRequestHandler(context, provider, middleware) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

    _classCallCheck(this, XVIZProviderRequestHandler);
  ...
  _createClass(XVIZProviderRequestHandler, [{
    key: "_setupContext",
    ...
    value: function () {
      var _sendStateUpdate2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(id, transformState) {
        var _this = this;
    ...
    value: function () {
      var _sendAllStateUpdates2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(id, transformState) {
